...
function Work() {
  ...
  const projects = [
    { id: 1, name: "مشروع 1", description: "هذا هو وصف المشروع الأول", image: img1, category: "تطوير الويب" },
    { id: 2, name: "مشروع 2", description: "هذا هو وصف المشروع الثاني", image: img2, category: "تصميم الهويات" },
    { id: 3, name: "مشروع 3", description: "هذا هو وصف المشروع الثالث", image: img3, category: "تطبيقات الجوال" },
    { id: 4, name: "مشروع 4", description: "هذا هو وصف المشروع الرابع", image: img4 },
    { id: 5, name: "مشروع 5", description: "هذا هو وصف المشروع الخامس", image: img5, category: "تصميم الهويات" },
    { id: 6, name: "مشروع 6", description: "هذا هو وصف المشروع السادس", image: img6, category: "تطبيقات الجوال" },
    { id: 7, name: "مشروع 7", description: "هذا هو وصف المشروع السابع", image: img7, category: "تطبيقات الجوال" },
    { id: 8, name: "مشروع 8", description: "هذا هو وصف المشروع الثامن", image: img8, category: "تطبيقات الجوال" },
    { id: 9, name: "مشروع 9", description: "هذا هو وصف المشروع التاسع", image: img9, category: "تطوير الويب" },
  ];

  const buttons = ["كل العمال", "تطوير الويب", "تطبيقات الجوال", "تصميم الهويات"];
  ...
  return (
    <motion.div
      className="flex flex-col items-center justify-center h-auto w-full mx-auto pb-[50px] bg-[#E7EEFB] py-[100px] px-[20px] sm:px-[100px] mb-[90px]"
    ...
    >
      {/* Header Section */}
      <div>
        <motion.h1 className="text-3xl font-bold text-yellow-500 text-center" variants={buttonVariant}>
          أعمالنا
        </motion.h1>
        <motion.p className="text-xl mt-2 text-center text-gray-400" variants={buttonVariant}>
