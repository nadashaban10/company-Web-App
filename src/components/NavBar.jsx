...
function NavBar() {
  ...
  return (
    <>
      <div
        className={`navbar flex justify-between items-center sm:py-0 py-[50px] text-white sm:pt-[60px] px-[50px] md:px-[20px] transition-all duration-300 ${isNavbarFixed ? "fixed sm:top-[-30px] top- sm:pb-[20px] p-5 left-0 w-full hero shadow-lg z-50" : "relative"}`}
        role="navigation"
