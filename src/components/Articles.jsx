    ...
    >
      ...
      <div className='cards grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-7 justify-center mt-10 cursor-pointer '>
        {articles.map(article => (
          <div
            key={article.id}
            className='card bg-white shadow-md rounded-3xl p-3 sm:p-3 text-right transform transition duration-300 hover:scale-105 hover:shadow-xl relative sm:h-[425px] h-[425px]'
            role="article"
