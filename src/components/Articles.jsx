...
function Articles() {
  ...
  return (
    <motion.div className='articles flex flex-col items-start justify-center h-full w-[80%] mx-auto pb-[50px] mb-[120px]' id="articles"
      ...
      <div className='cards grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-7 justify-center mt-10 cursor-pointer space-y-5'>
        {articles.map(article => (
          <div key={article.id} className='card bg-white shadow-md rounded-3xl p-3 sm:p-3 text-right transform transition duration-300 hover:scale-105 hover:shadow-xl relative sm:h-[450px] h-[450px]'>
            ...
            <div className='flex items-center  text-[rgba(38,89,97,1)] justify-center gap-2 absolute bottom-4 font-semibold left-3 w-[180px] px-4 py-2 bg-gray-200 text-center rounded-full hover:bg-[#266157] hover:text-white'>
              <button className=''>
                عرض المزيد
              </button>
